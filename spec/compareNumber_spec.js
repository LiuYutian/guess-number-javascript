...
describe("compareNumber", function() {
    ...
    it("#comparison() error sequence test：2134，1234", function() {
    ...
    it("#comparison() error number and error sequence test：3456，1234", function() {
    ...
    it("#comparison() null a and null b sequence test：1234，5678", function() {
        var compareNumber = new CompareNumber("1234");
    ...
    it("#comparison() repeat data if test：1111，1234", function() {
        var compareNumber = new CompareNumber("1234");
